...
> 版本：v1.4 | 更新时间：2026-03-31

---

## 1. 功能总览

AllFi 是一个功能完整的全资产聚合平台，当前仓库实现涵盖 **12 个页面**（9 个业务页面 + 3 个认证页面）、**58 个组件**、**78 个 API 定义**、**7 个 DeFi 协议**、**10 个定时任务**。以下按功能模块详细说明。
...
|------|------|------|
| **Go** | 1.24 | 后端语言 |
| **GoFrame** | 2.10 | Web 框架、路由、配置、OpenAPI |
| **GoFrame gdb** | 2.10 | 数据访问层 |
| **SQLite** | — | 默认数据库（零配置） |
| **AES-256-GCM** | — | 加密存储 |
| **bcrypt** | — | 密码哈希 |
| **JWT** | — | 令牌认证 |
